...
{
    _objCollectionDataSource = [[HDCollectionDataSource alloc] initWithItems:_arrItems multipleCellBlock:^NSString *(id item, NSIndexPath *indexPath) {
    ...
    _collectionItems.dataSource= _objCollectionDataSource;
}
